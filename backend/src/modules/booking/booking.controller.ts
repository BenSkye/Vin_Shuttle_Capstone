...
export class BookingController {
  ...
  async bookingHour(@Request() req, @Body() data: IBookingHourBody) {
  ...
  async bookingScenicRoute(@Request() req, @Body() data: IBookingScenicRouteBody) {
  ...
  async bookingDestination(@Request() req, @Body() data: IBookingDestinationBody) {
