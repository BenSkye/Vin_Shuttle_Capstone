...
export class SearchController {
    ...
    async getAvailableVehicleBookingHour(
        ...
        return await this.searchService.findAvailableVehicleBookingHour(date, startTime, durationMinutes)
    }
    ...
    async getAvailableVehicleBookingScenicRoute(
        ...
        return await this.searchService.findAvailableVehicleBookingScenicRoute(scenicRouteId, date, startTime)
    }



    @Get('available-vehicle-search-scenic-route/:startPoint/:endPoint/:estimatedDuration/:estimatedDistance')
    @HttpCode(HttpStatus.OK)
    @ApiOperation({ summary: 'Get available vehicle category, number and price for booking hour when customer provide time and duration' })
    @ApiParam({
        name: 'startPoint',
    ...
    async getAvailableVehicleBookingDestination(
        ...
        return await this.searchService.findAvailableVehicleBookingDestination(startPoint, endPoint, estimatedDuration, estimatedDistance)
    }
