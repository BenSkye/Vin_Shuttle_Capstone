...
import { CreateVehicleCategoryDto, ICreateVehicleCategoryDto, IUpdateVehicleCategoryDto, UpdateVehicleCategoryDto } from "src/modules/vehicle-categories/vehicle-category.dto";
...
export class VehicleCategoryController {
    ...
    @ApiParam({ name: 'id', description: 'The id of the vehicle category', example: '67873bb9cf95c847fe62ba5f' })
